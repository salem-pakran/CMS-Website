...
@endif
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2 class="sub_title">Edit Content</h2>
        ...
        <div class="x_content">
            <div class="form-group has-feedback" style="position: relative;">
                ...
                {{form::select('page_title',$post->page_title,['class'=>'form-control'])}}
            </div>
            <div class="form-group has-feedback" style="position: relative;">
                <label for="name" class="hws_form_label">Section Title :</label>
                {{form::select('section_title',$post->section_title,['class'=>'form-control'])}}
            </div>
            <div class="form-group has-feedback" style="position: relative;">
